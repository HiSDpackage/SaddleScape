...
title: "SaddleScape-1.0: 使用高阶鞍点动力学（HiSD）构建解景观"
excerpt: "快速入门指南"
sidebar:
    nav: docs_Chinese
toc: true
...
1. **添加路径**:
   ...
   将  `'/path/to/saddlescape-1.0'` 替换为实际的 `saddlescape-1.0` 目录路径。
...
更多详细用法请参考[documentation](https://github.com/HiSDpackage/saddlescape/blob/main/doc/Documentation.pdf)文件。（您也可以在左侧的["教程"](https://hisdpackage.github.io/saddlescape/Tutorial/Tutorial_overview)部分查看）
...
[GitHub仓库](https://github.com/HiSDpackage/saddlescape)的`gallery`目录中提供以下示例Jupyter Notebook文件：（您也可以在左侧的["示例"](https://hisdpackage.github.io/saddlescape/Examples/Examples_overview)部分查看）
